        ...
        <CardActionArea>
            <Card className={classes.root}>
                ...
                <CardContent>
                    ...
                    {props.open ?<li className="Card-res--list open">Open until {props.closeHour}</li>
                        : <li className="Card-res--list close" >Closed <span className="open">opens at {props.openHour}</span></li>}
                    </div>
                    <div className="Card-res--ul">
