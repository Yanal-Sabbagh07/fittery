            ...
            <CardActionArea>
                ...
                <CardContent>
                    <Typography gutterBottom variant="h6" component="h6">
                        ...
                        <div className="Card-map--type">{props.cuisine} {props.type}</div>
                        </Typography>
                        <div className="Card-map--hours"> 
                            {props.open ?
                            <li className="Card-map--hours open">Open until <span className="close">{props.closeHour}</span></li>
                            :
                            <div>
                            <li className="Card-map--hours card-res--name close" >Closed</li>
                            <li className="Card-map--hours open">Openes at {props.openHour}</li>
                            </div>}
                        </div>
                </CardContent>
                </CardActionArea>
